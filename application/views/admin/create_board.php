                    ...
                    <div class="div_wrapper">
                        ...
                        <div>
                            ...
                            <div style="margin-left: 33%">
                                <input required="" class="form-control" type="text" style="width: 68.5%"  class = "control-label" placeholder="Board Name" id="name1" name="name" ><div style =" color: red; display: none;padding-left:43%" id="berror"> Enter Board Name </div>
                            </div>
                        </div>
                        ...
                        <div>  
                            ...
                            <div style="margin-left: 33%">
                                <input required="" class="form-control" type="text" style="width: 68.5%"  class = "control-label" placeholder="Board Title" id="title1" name="title" ><div style =" color: red; display: none;padding-left:43%" id="terror"> Enter Board Title </div>
                            </div>   
                        </div>
                        <div style="margin-top: 5px"></div>
                        <div class="control-group">
                            ...
                            <div style="margin-left: 33%">
                                <select required="" multiple="" class="chosen-select" data-placeholder="Choose a Parent Tag..." tabindex="4" id="parentTag1" name="parentTag1" >
