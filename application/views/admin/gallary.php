                ...
                foreach ($ar as $img_name) {
                    if ($img_name != '.' && $img_name != '..') { {
                            ...
                            <div id='img_<?= $i ?>' style="position:relative;float:left;padding:10px">
                                ...
                                <div style='position:absolute;top:5px;left:96px'>   <a  href="javascript:deletbox('<?php echo site_url('/admin/Item/delete_image/' . $img_name . '/' . $id) ?>','<?= $i ?>')" ><img src="<?php echo base_url(); ?>assets/img/uploadify-cancel.png"></a>
                                </div> </div>
            <?
            }
        }
