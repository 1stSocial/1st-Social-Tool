    ...
    <div class="modal-body" style="overflow: auto ! important;">
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <div style='magrin-top:33px;padding-left:31%;'>
...
<? if (!empty($Taxonomy)): foreach ($Taxonomy as $val): ?>
    ...
    <div class="modal-footer">
        <div class="control-group div_wrapper">
            ...
            <input type="submit" style="margin-left: 13%" class="btn btn-primary footer_btn" value="Update Item" onclick="//savefun('<?php // echo site_url("/admin/item/update_item/"); ?>')" />
