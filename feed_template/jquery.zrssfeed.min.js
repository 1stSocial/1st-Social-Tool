...
html+='<li class="rssRow '+row+'">'+'<table border="0" bordercolor="" style="background-color:" width="500px" cellpadding="0" cellspacing="0" valign="top"><tr><td valign="top"><'+options.titletag+'><a href="'+entry.link+'" title="View job '+entry.title+'" target="_blank">'+entry.title+'</a></'+options.titletag+'>'
...
html+='<p>'+content+'</p></td><td valign="top"><div class="qrcode"><a href="http://qrcode.kaywa.com/img.php?s=5&d='+entry.link+'"><img src="http://qrcode.kaywa.com/img.php?s=5&d='+entry.link+'" width="104px" border="0px"></a></div></td></tr><tr><td valign="bottom"><div class="facebook"><iframe src="http://www.facebook.com/plugins/like.php?app_id=248854778481507&amp;href='+entry.link+'&amp;send=false&amp;layout=standard&amp;width=340&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=35" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:340px; height:35px;" allowTransparency="true"></iframe></div></td><td valign="middle"><a href="'+entry.link+'" target="_blank"><div class="button_outside_border_blue"><div class="button_inside_border_blue">More Info</div></div></a></td></tr></table>'}
